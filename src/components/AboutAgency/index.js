...
const AboutAgency = (props) => {
    ...
    return ( <
        ...
        src = { about_left_image ? about_left_image : Shape2 }
        alt = "shape" / >
        <
        /Grid> <
        /Grid> <
        ...
        <
        strong > { about_sub_title ? about_sub_title : 'Know About einzigartige' } < /strong> <
        h2 > { about_title ? about_title : 'einzigartige For Your Business Solution' } < /h2> <
